...
<div class="row">
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#test'
                ,url:'/Manage/Usdt/dmrLogList?token='+token
                ,toolbar: '#toolbarDemo'
                ,title: 'DMR流水'
                ,limit:15
                ,cols: [[
                    ...
                    ,{field:'to_uid', title:'对方用户ID', width:200}
                    ,{field:'ad_dmr', title:'DMR地址', width:200}
                    ,{field:'datetime', title:'交易时间', width:180, edit: 'text'}
                    ,{field:'orderid', title:'订单号', width:280}
                    ,{field:'ser_money', title:'手续费', width:280}
                    ,{field:'dmr', title:'总交易DMR数量', width:200}
                    ,{field:'d_frozen', title:'其中冻结数量', width:200}
                    ,{field:'ac_money', title:'对方总到账数量', width:200}
