...
<div class="row">
                ...
                <form class="layui-form" action="" method="get" autocomplete="off" id="orderform">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <a onclick="editPass()" class="layui-btn layui-btn-warm"><span class="glyphicon glyphicon-pencil"></span> 修改密码</a>
                            <a onclick="add()" class="layui-btn layui-btn-warm"><span class="glyphicon glyphicon-plus"></span> 添加管理员</a>
                        </div>
                    </div>
                </form>
    ...
    <script>
        ...
        function add() {
            var storage=window.localStorage;
            var token=storage.getItem('token');
            order_view('增加管理员', '/Manage/Other/add?token='+token,600,500);
        }
    </script>
    </body>
    </html>
