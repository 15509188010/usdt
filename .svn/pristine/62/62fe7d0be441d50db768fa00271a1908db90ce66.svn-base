...
<div class="row">
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#test'
                ,url:'/Manage/Usdt/orderOutList?token='+token
                ,toolbar: '#toolbarDemo'
                ,title: 'usdt转出'
                ,limit:15
                ,cols: [[
                    ...
                    ,{field:'uid', title:'用户名', width:150, edit: 'text'}
                    ,{field:'orderid', title:'订单号', width:300, edit: 'text'}
                    ,{field:'usdt', title:'数量', width:200}
                    ,{field:'ser_money', title:'手续费', width:200}
                    ,{field:'ad_usdt', title:'USDT地址', width:200}
                    ,{field:'datetime', title:'修改时间', width:200}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    //驳回
                    order_view('驳回', '/Manage/Usdt/delOutEdit?token='+token+'&id='+id,500,400);
                } else if(obj.event === 'pass'){
                    //通过
                    layer.confirm('您确定通过此转出订单吗？',function(index){
                        $.ajax({
                            url:"/Manage/Usdt/passOut",
                            type:'post',
