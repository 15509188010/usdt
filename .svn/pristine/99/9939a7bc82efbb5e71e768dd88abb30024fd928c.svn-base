...
<div class="row">
    ...
    <script type="text/html" id="barDemo">
        <a class="layui-btn" lay-event="show" style="line-height: 30px;">查看</a>
        <a class="layui-btn" lay-event="del" style="line-height: 30px;">驳回</a>
        <a class="layui-btn" lay-event="pass" style="line-height: 30px;">通过</a>
    </script>
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#test'
                ,url:'/Manage/Usdt/changeLogList?token='+token
                ,toolbar: '#toolbarDemo'
                ,title: 'DMR流水'
                ,limit:15
                ,cols: [[
                    ...
                    ,{field:'uid', title:'用户ID', width:80, edit: 'text'}
                    ,{field:'ymoney', title:'原账户总额', width:200}
                    ,{field:'money', title:'变动金额', width:200}
                    ,{field:'gmoney', title:'变动后总额', width:180, edit: 'text'}
                    ,{field:'datetime', title:'变动时间', width:280}
                    ,{field:'transid', title:'交易流水号', width:200}
                    ,{field:'lx', title:'入账/出账', width:200}
                    ,{field:'type', title:'USDT/DMR', width:200}
                    ,{field:'contentstr', title:'备注', width:200}
                    ,{field:'t', title:'结算周期', width:200}
                ]]
                ,page: true
            });
