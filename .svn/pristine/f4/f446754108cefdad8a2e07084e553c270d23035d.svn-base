...
<div class="row">
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <blockquote class="layui-elem-quote" style="font-size:14px;padding;8px;">总会员数：<span class="label label-info">500</span>
                </blockquote>
    ...
    <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-small" lay-event="add" style="line-height: 32px;">赠送DMR</a>
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#test'
                ,url:'/Manage/User/userList?token='+token
                ,toolbar: '#toolbarDemo'
                ,title: '会员列表'
                ,cols: [[
                    ...
                    ,{field:'usdt', title:'USDT余额', width:180 ,style:'background-color: #009688; color: #fff;'}
                    ,{field:'u_onway', title:'USDT在途', width:180 ,style:'background-color: #009688; color: #fff;'}
                    ,{field:'dmr', title:'DMR可用', width:180 ,style:'background-color: #009688; color: #fff;'}
                    ,{field:'d_frozen', title:'DMR冻结', width:180 ,style:'background-color: #009688; color: #fff;'}
                    ,{field:'ad_dmr', title:'DMR地址', width:300, edit: 'text'}
