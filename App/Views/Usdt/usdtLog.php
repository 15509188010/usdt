...
<div class="row">
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#test'
                ,url:'/Manage/Usdt/usdtLogList?token='+token
                ,toolbar: '#toolbarDemo'
                ,title: 'usdt转入'
                ,limit:15
                ,cols: [[
                    ...
                    ,{field:'uid', title:'用户ID', width:150, edit: 'text'}
                    ,{field:'datetime', title:'时间', width:200}
                    ,{field:'usdt', title:'交易数量', width:180, edit: 'text'}
                    ,{field:'orderid', title:'订单号', width:280}
                    ,{field:'ad_usdt', title:'转入USDT地址', width:200}
                    ,{field:'lx', title:'转入/转出', width:200}
                    ,{field:'operator', title:'审核人员id', width:200}
                    ,{field:'contentstr', title:'审核备注', width:200}
